...
## Significance: Clinical applications
 ...
 - Try to be specific as much as possible and assume there is a clinician reading your grant who cares deeply abou this issue.
...
## Innovation
 ...
 - Many ways to be innovative:
   ...
   - Studying a new idea
   - Introducing a new theoretical theory

 - In practice, I have found that reviewers have an easier time saying nice thingsi about innovation when it is technical ("We are using a machine that no one else has") as opposed to theoretical. But, it varies a lot by reviewer.
...
- Predictions
- Preliminary data
- Challenges, potential pitfalls, and alternate outcomes
