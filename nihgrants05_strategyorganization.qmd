...
## Paragraphs
 ...
 - When in doubt, go back to basics: One main topic per paragraph, which is introduced with a topic sentence, and ends with a conclusing sentence.


## Significance

 - Not a literature review!
 - But, need to walk reviewers through relevant literature to hihlight the critical gap in the field that your proposal addresses
 ...
 ## Approach
  ...
  - Often helpful to include an overview to provide the general structure and logic
    ...
    - If you have a shorter significance and then a "background" section, you can put the overview right before specific aims
